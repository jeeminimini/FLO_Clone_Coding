...
class SavedSongRVAdapter(): RecyclerView.Adapter<SavedSongRVAdapter.ViewHolder>() { //6주차에는 그냥 먼저 노래들을 보관함에 넣어줬는데, 7주차에는 좋아요 누른 것만 넣어줌
    ...
    override fun onBindViewHolder(holder: SavedSongRVAdapter.ViewHolder, position: Int) { //인덱스 아이디가 position이다.
        ...
        holder.binding.itemSavedSongPlayerMoreIv.setOnClickListener {
